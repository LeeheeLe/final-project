...
/*
 * Purpose:
 * The entry point of the program. This function processes the command-line arguments,
 * performs preprocessing on each file, and then runs the first pass assembler process
 * on the specified files.
 *
 * The program expects at least one argument (the file to process). If no arguments
 * are provided, an error message is displayed.
 *
 * Functionality:
 ...
 * - Calls the `first_pass` function to execute the first pass of the assembler on each file.
 * //todo complete this documenting acording to the last things we finish
*
 * @param argc The number of command-line arguments.
 * @param argv The array of command-line argument strings.
 *
 * @return int Returns 0 if successful, 1 if an error occurs (like missing file argument).
 */
